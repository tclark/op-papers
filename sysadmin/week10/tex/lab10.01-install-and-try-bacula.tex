...
Carry out the following procudure on your \texttt{backups} server.
...
\begin{enumerate}
  ...
  \item Now you are ready to run some backup and restore jobs.  Open a second ssh session to your \texttt{backups} server. In it, run the 
